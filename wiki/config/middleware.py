# -*- coding: utf-8 -*-
"""WSGI middleware initialization for the Wiki application."""
from wiki.config.app_cfg import base_config
from wiki.config.environment import load_environment
...
def make_app(global_conf, full_stack=True, **app_conf):
    ...
    :param global_conf: The global settings for Wiki (those

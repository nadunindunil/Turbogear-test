# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in Wiki.
...
base_config.model = wiki.model
base_config.DBSession = wiki.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "d04b0a21-f0b2-4965-9151-1efb152f9ae3"
